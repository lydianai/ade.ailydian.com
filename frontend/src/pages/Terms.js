...
export default function Terms() {
    ...
    return (_jsxs("div", { className: "min-h-screen", children: [_jsx(Header, {}), _jsxs("section", { className: "pt-32 pb-20 section-padding relative overflow-hidden", children: [_jsx("div", { className: "absolute top-20 left-10 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl animate-float" }), _jsxs("div", { className: "container-custom relative z-10", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, className: "text-center max-w-4xl mx-auto mb-16", children: [_jsxs("h1", { className: "text-5xl md:text-7xl font-bold mb-8", children: [_jsx("span", { className: "text-white", children: "Kullan\u0131m " }), _jsx("span", { className: "text-gradient-amber-teal", children: "\u015Eartlar\u0131" })] }), _jsx("p", { className: "text-xl text-white/70", children: "ADE platformunu kullan\u0131rken ge\u00E7erli olan \u015Fartlar" }), _jsx("p", { className: "text-sm text-white/50 mt-4", children: "Son g\u00FCncelleme: 15 Ocak 2026" })] }), _jsx("div", { className: "max-w-4xl mx-auto space-y-6", children: sections.map((section, index) => (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, className: "glass-card-premium p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-white mb-4", children: section.title }), _jsx("p", { className: "text-white/80 leading-relaxed", children: section.content })] }, index))) }), _jsxs(motion.div, { initial: { opacity: 0 }, whileInView: { opacity: 1 }, viewport: { once: true }, className: "glass-card-premium p-12 text-center max-w-3xl mx-auto mt-16", children: [_jsx(ScaleIcon, { className: "w-16 h-16 text-amber-400 mx-auto mb-6" }), _jsx("h2", { className: "text-3xl font-bold text-white mb-4", children: "Sorular\u0131n\u0131z m\u0131 Var?" }), _jsx("p", { className: "text-xl text-white/70 mb-6", children: "Kullan\u0131m \u015Fartlar\u0131 hakk\u0131nda destek al\u0131n" }), _jsx("p", { className: "text-white/80", children: "Email: hukuk@ade.gov.tr" })] })] })] }), _jsx(Footer, {})] }));
}
