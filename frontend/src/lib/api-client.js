...
export const authApi = {
    kayitOl: (data) => apiClient.post('/auth/kayit-ol', data),
    girisYap: (data) => apiClient.post('/auth/giris-yap', data),
    cikisYap: () => apiClient.post('/auth/cikis-yap'),
    profil: () => apiClient.get('/auth/profil'),
    tokenYenile: (refreshToken) => apiClient.post('/auth/token-yenile', { refreshToken }),
};
